...
export function Step3Preview({ inviteCode }: Step3PreviewProps) {
	...
	return (
		<>
			...
			<div className="relative mt-12 h-[460px]">
				...
				<motion.div
					className="absolute bottom-12 left-48 size-40 rounded-full bg-amber-50 shadow-[0_22px_55px_rgba(15,23,42,0.1)] ring-1 ring-foreground/5"
