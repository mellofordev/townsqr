...
export const Route = createFileRoute("/notifications/mentions")({
	loader: requireWorkspaceRoute,
	component: MentionsNotificationsPage,
	head: () => ({
		meta: [{ title: "Mentions | TownSqr Notifications" }],
	}),
});
...
function MentionsNotificationsPage() {
	return (
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-6">
			<header className="border-b pb-5">
				...
				<p className="mt-2 max-w-2xl text-sm text-muted-foreground">
					Mentions and replies that need your direct attention.
				</p>
			</header>
