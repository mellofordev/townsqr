...
export const Route = createFileRoute("/notifications/unread")({
	loader: requireWorkspaceRoute,
	component: UnreadNotificationsPage,
	head: () => ({
		meta: [{ title: "Unread | TownSqr Notifications" }],
	}),
});
	...
	return (
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-6">
			<header className="border-b pb-5">
				...
				<h1 className="mt-1 text-2xl font-semibold tracking-normal">Unread</h1>
				<p className="mt-2 max-w-2xl text-sm text-muted-foreground">
					Unread notification items across your workspace.
				</p>
			</header>
