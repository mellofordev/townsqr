...
export const Route = createFileRoute("/notifications/announcements")({
	...
	component: AnnouncementNotificationsPage,
	head: () => ({
		meta: [{ title: "Announcements | TownSqr Notifications" }],
	}),
});
...
function AnnouncementNotificationsPage() {
	return (
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-6">
			<header className="border-b pb-5">
				...
				<p className="mt-2 max-w-2xl text-sm text-muted-foreground">
					Workspace announcements and admin updates.
				</p>
			</header>
