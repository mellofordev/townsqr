...
export const Route = createFileRoute("/chat/dm/$memberId")({
	loader: requireWorkspaceRoute,
	component: MemberDirectMessagePage,
	head: () => ({
		meta: [{ title: "Direct Message | TownSqr Chat" }],
	}),
});
...
function MemberDirectMessagePage() {
		...
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-6">
			<header className="border-b pb-5">
				...
				<p className="mt-2 max-w-2xl text-sm text-muted-foreground">
					Direct message conversation with this member.
				</p>
			</header>
